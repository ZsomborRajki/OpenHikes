...
struct MapPaywallView: View {
    ...
    private var restoreRow: some View {
        VStack(spacing: 6) {
            ...
            // the label would push them apart. It is the only control on this
            // screen the app lays out itself — everything else is drawn by
            // `SubscriptionStoreView`, which sizes its own.
            .minimumTapTarget()
