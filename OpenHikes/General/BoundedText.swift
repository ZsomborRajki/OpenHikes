...
/// hold.
nonisolated struct TextBound: Equatable, Sendable {
    ...
    var utf8Bytes: Int { characters * 4 }
...
nonisolated extension TextBound {
    ...
    static let title = Self(characters: titleCharacters)
    ...
    static let credit = Self(characters: creditCharacters)
    ...
    /// than anybody writes.
    static let notes = Self(characters: notesCharacters)

    /// A GPX file's `metadata/keywords`: a comma-separated list, not a
    /// sentence. Room for a few dozen of them.
    static let keywords = Self(characters: keywordsCharacters)
}

/// Trims and bounds free text.
nonisolated enum BoundedText {
    ...
    static func bounded(_ raw: String?, to bound: TextBound) -> String? {
    ...
    static func boundedOrEmpty(_ raw: String?, to bound: TextBound) -> String {
