...
//  nowhere else.
//
//  The position this file implements: for battery telemetry, prefer native
//  Instruments, signposts and MetricKit rather than an analytics SDK that
//  adds its own network and background cost. A hiking
