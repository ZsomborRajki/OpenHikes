...
nonisolated final class PerformanceUITests: XCTestCase {
    ...
    func testIdleCostsNothing() {
        ...
        assertNoMoreThan(2, of: "OpenTrailsViewBody", in: idle, phase: "idle")
    ...
    func testMapBrowsingDoesNotReRenderTheSheet() {
        ...
        assertNoMoreThan(4, of: "OpenTrailsViewBody", in: browsing, phase: "browsing")
    ...
    func testChartScrubbingStaysInsideTheChart() {
        ...
        // chart at all.
        assertNoMoreThan(0, of: "OpenTrailsViewBody", in: drag, phase: "scrub-drag")
    ...
    func testLiveRecordingCostPerFix() {
        ...
        assertRatio(atMost: 1.5, of: "OpenTrailsViewBody", per: fixes, in: delta)
...
private extension PerformanceUITests {
    ...
    /// the same contract `OpenTrailsUITests` works under.
    @MainActor
