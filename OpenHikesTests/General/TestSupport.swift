...
///
/// Here rather than beside one suite's fixtures because two unrelated
/// subjects need the same thing — a photo authorization callback caught
/// mid-flight, and a recorder's journal write held open while a permission
/// refusal overtakes it.
///
