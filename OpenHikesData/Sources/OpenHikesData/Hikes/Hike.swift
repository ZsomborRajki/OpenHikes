...
public final class Hike {
    ...
    public var tintHex: String = "#1B7F3B"
    /// Map polyline width, in points.
    public var routeWidth: Double = 3
    ...
    public var autoFollowEnabled: Bool = true
    ...
    public var communitySubmissionID: String?
    ...
    public var communityListingID: String?
    ...
    public var communityPhotoSubmissionID: String?
    ...
    public var communityPhotoContributionID: String?
    ...
    public var importedFromListingID: String?
    ...
    /// it.
    public var importedAuthorName: String?
    ...
    public var surfaceMetersByCategory: [String: Double] = [:]
    ...
    public var difficultyMetersByGrade: [String: Double] = [:]
    ...
    public var drawnRouteData: Data?
    ...
    @Transient public var cachedLocalState: HikeLocalState?
...
extension Hike {
    ...
    public var localState: HikeLocalState? { try? resolveLocalState() }
    ...
    public func resolveLocalState() throws -> HikeLocalState? {
    ...
    public var autoSaveTilesEnabled: Bool {
    ...
    public var ownsRecordingDraft: Bool {
