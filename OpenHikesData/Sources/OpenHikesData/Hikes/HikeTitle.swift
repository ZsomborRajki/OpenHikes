...
nonisolated public enum HikeTitle {
    ...
    public static let maximumCharacters = TextBound.title.characters
    ...
    public static let maximumUTF8Bytes = TextBound.title.utf8Bytes
    ...
    public static func bounded(_ raw: String?) -> String? {
    ...
    public static func imported(trackName: String?, fileURL: URL) -> String {
        bounded(trackName)
    ...
    public static func imported(trackName: String?, fileURL: URL, trackNumber: Int) -> String {
        bounded(trackName)
    ...
    public static func drawn(name: String?, madeOn date: Date) -> String {
    ...
    public static func watchRecording(trailName: String?, recordedAt: Date) -> String {
...
nonisolated public enum HikeTitleEdit: Equatable {
    ...
    public static func of(_ draft: String, against displayTitle: String) -> Self {
