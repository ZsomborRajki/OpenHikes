...
nonisolated public enum RouteLinePattern: String, CaseIterable, Identifiable, Sendable {
    ...
    public static let `default`: RouteLinePattern = .directional
    ...
    public var drawsLine: Bool { self != .arrowheads }

    public var drawsChevrons: Bool { self == .directional || self == .arrowheads }
    ...
    public var chevronsUseRouteTint: Bool { self == .arrowheads }
    ...
    public func dashLengths(forWidth width: Double) -> [Double] {
    ...
    public func chevronMetrics(forWidth width: Double) -> RouteChevronMetrics? {
...
nonisolated public struct RouteChevronMetrics: Equatable, Sendable {
    ...
    /// collided anyway.
    public var retraceClearance: Double { spacing * Self.retraceClearanceFraction }
    ...
    public var overlapClearance: Double { halfLength + halfWidth }
    ...
    public static let collinearAlignment: Double = 0.5

    private static let retraceClearanceFraction: Double = 0.75

    public init(spacing: Double, halfLength: Double, halfWidth: Double, strokeWidth: Double) {
...
nonisolated public enum RouteChevronShade {
    /// Kept opaque so a chevron reads even on a translucent route.
    public static let alpha: Double = 0.95
    ...
    public static func gray(forLuminance luminance: Double) -> Double {
