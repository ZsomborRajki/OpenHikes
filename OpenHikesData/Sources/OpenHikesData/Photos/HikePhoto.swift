...
nonisolated public struct HikePhoto: Codable, Hashable, Identifiable, Sendable {
    ...
    public var matchEvidence: PhotoMatchEvidence?
    ...
    public var sentToCommunityAt: Date?
    ...
    public var isPlaceOnly: Bool? // swiftlint:disable:this discouraged_optional_boolean
    ...
    public var isOwn: Bool { importedFromListingID == nil }
    ...
    public var recordsPlaceOnly: Bool { isPlaceOnly == true }
    ...
    public struct Origin: Sendable {
        ...
        public static var own: Self { Self() }
    ...
    public var isAnchored: Bool { coordinate != nil }
    ...
    public var hasBeenSentToCommunity: Bool { sentToCommunityAt != nil }

    /// The file the pixels are stored under, relative to the photo directory.
    public var fileName: String { "\(id.uuidString).\(pathExtension)" }
